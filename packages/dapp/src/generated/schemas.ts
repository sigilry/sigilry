...
export const ConnectedEventSchema = z.object({ "provider": z.object({ "id": z.string().describe("The unique identifier of the Provider."), "version": z.string().describe("The version of the Provider.").optional(), "providerType": z.enum(["browser","desktop","mobile","remote"]).describe("The type of client that implements the Provider."), "url": z.string().describe("The URL of the Wallet Provider.").optional(), "userUrl": z.string().url().describe("A URL that points to a user interface.").optional() }).strict().describe("Represents a Provider."), "connection": z.object({ "isConnected": z.boolean().describe("Whether or not the user is authenticated with the Wallet."), "reason": z.string().describe("The reason why the user is not connected to the Wallet.").optional(), "isNetworkConnected": z.boolean().describe("Whether or not a connection to a network is established."), "networkReason": z.string().describe("If not connected to a network, the reason why.").optional(), "userUrl": z.string().url().describe("A URL that points to a user interface.").optional() }).strict(), "network": z.object({ "networkId": z.string().describe("A CAIP-2 compliant chain ID, e.g. 'canton:da-mainnet'."), "ledgerApi": z.string().url().describe("The base URL of the ledger API.").optional(), "accessToken": z.string().describe("JWT authentication token.").optional() }).strict().describe("Network information, if connected to a network.").optional(), "session": z.object({ "accessToken": z.string().describe("JWT authentication token."), "userId": z.string().describe("The user identifier.") }).strict().describe("Session information, if authenticated.").optional() }).strict().describe("CIP-103 §4.2.2 connected event payload. Identical shape to StatusEvent (same as StatusChangedEvent); the per-event schema is kept distinct so generators can emit a type that codifies the login-flow-only emit trigger.")
...
export const StatusChangedEventSchema = z.object({ "provider": z.object({ "id": z.string().describe("The unique identifier of the Provider."), "version": z.string().describe("The version of the Provider.").optional(), "providerType": z.enum(["browser","desktop","mobile","remote"]).describe("The type of client that implements the Provider."), "url": z.string().describe("The URL of the Wallet Provider.").optional(), "userUrl": z.string().url().describe("A URL that points to a user interface.").optional() }).strict().describe("Represents a Provider."), "connection": z.object({ "isConnected": z.boolean().describe("Whether or not the user is authenticated with the Wallet."), "reason": z.string().describe("The reason why the user is not connected to the Wallet.").optional(), "isNetworkConnected": z.boolean().describe("Whether or not a connection to a network is established."), "networkReason": z.string().describe("If not connected to a network, the reason why.").optional(), "userUrl": z.string().url().describe("A URL that points to a user interface.").optional() }).strict(), "network": z.object({ "networkId": z.string().describe("A CAIP-2 compliant chain ID, e.g. 'canton:da-mainnet'."), "ledgerApi": z.string().url().describe("The base URL of the ledger API.").optional(), "accessToken": z.string().describe("JWT authentication token.").optional() }).strict().describe("Network information, if connected to a network.").optional(), "session": z.object({ "accessToken": z.string().describe("JWT authentication token."), "userId": z.string().describe("The user identifier.") }).strict().describe("Session information, if authenticated.").optional() }).strict().describe("CIP-103 §4.2.2 statusChanged event payload. Identical shape to StatusEvent; kept as a distinct schema so generators can emit a per-event type that codifies the emit-trigger contract.")
...
export interface RpcMethods {
  ...
  statusChanged: { params: void; result: StatusChangedEvent }
  connected: { params: void; result: ConnectedEvent }
}
